# Generated by Django 2.0.7 on 2018-07-06 10:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, help_text='May be left blank. e.g. tracking identifier from reference model that opened the item.', max_length=50, null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AddField(
            model_name='action',
            name='action_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='action', to='edc_action_item.ActionType', verbose_name='Action'),
        ),
    ]
