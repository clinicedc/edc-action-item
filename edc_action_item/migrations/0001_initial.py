    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_identifier', models.CharField(help_text='e.g. tracking identifier updated from the reference model', max_length=50, null=True)),
                ...
                ('instructions', models.TextField(blank=True, help_text='populated by action class', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_by_action', models.BooleanField(default=True, help_text='This action may be created by another action')),
                ('create_by_user', models.BooleanField(default=True, help_text='This action may be created by the user')),
