# Generated by Django 2.0 on 2017-12-03 20:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(blank=True, help_text='Leave blank to use the action type name.', max_length=50, null=True, verbose_name='Name')),
                ('name', models.CharField(editable=False, help_text='Leave blank to use the action type name.', max_length=50, null=True)),
                ('reference_identifier', models.CharField(editable=False, help_text='e.g. tracking identifier from source model', max_length=50, null=True)),
                ('reference_model', models.CharField(editable=False, max_length=50, null=True)),
                ('parent_reference_identifier', models.CharField(editable=False, help_text='e.g. tracking identifier from source model that opened the item.', max_length=50, null=True)),
                ('parent_model', models.CharField(editable=False, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_action', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionType', verbose_name='Next action')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='action_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='action_type', to='edc_action_item.ActionType', verbose_name='Action'),
        ),
        migrations.AddField(
            model_name='actionitem',
            name='next_action_type',
            field=models.ForeignKey(blank=True, help_text='Leave blank to use default for this action type.', null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionType', verbose_name='Next action'),
        ),
        migrations.AddField(
            model_name='actionitem',
            name='parent_action',
