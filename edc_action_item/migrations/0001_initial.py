# Generated by Django 2.0 on 2017-12-06 02:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_reference_identifier', models.CharField(blank=True, help_text='May be left blank. e.g. tracking identifier from source model that opened the item.', max_length=50, null=True)),
                ('parent_model', models.CharField(editable=False, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prn_form_action', models.BooleanField(help_text='If True, specify model.', verbose_name='Action requires a PRN form to be completed?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.HistoricalActionItem')),
            ],
            options={
